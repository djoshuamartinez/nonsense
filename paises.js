...
function numberOfVowels(word){
    return word.toLowerCase().replace(/[^aeiouáéíóú]+/g, '').length;
}

var vowelCount = countries.map(c=>[c, numberOfVowels(c)]);
var possibleCounts = [... new Set(vowelCount.map(vc=>vc[1])) ].sort((a,b)=>a-b);
